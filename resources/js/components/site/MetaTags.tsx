...
export function MetaTags({
    ...
    const fullTitle = title.includes(defaultTitle) ? title : `${title} — ${defaultTitle}`;
    ...
    return (
        <Head>
            ...
            <meta head-key="author" name="author" content="Moroccan Club Travel" />
            ...
            <meta head-key="og:site_name" property="og:site_name" content="Moroccan Club Travel" />
            ...
            {/* Canonical Link */}
            {cleanCanonical && <link head-key="canonical" rel="canonical" href={cleanCanonical} />}
        </Head>
    );
}
