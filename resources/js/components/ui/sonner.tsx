...
function Toaster({ ...props }: ToasterProps) {
    ...
    return (
        <Sonner
            ...
            toastOptions={{
                classNames: {
                    toast: "group toast group-[.toaster]:bg-background group-[.toaster]:text-foreground group-[.toaster]:border-border group-[.toaster]:shadow-xl group-[.toaster]:rounded-none",
                    ...
                    title: "group-[.toast]:font-display group-[.toast]:text-base font-semibold",
