...
return dataVal.length > 0
    ...
    const initialStartingPoint = tour.startingPoint || tour.starting_point || '';
    ...
    const { data, setData, post, processing, errors, transform } = useForm({
        ...
        nights: tour.nights || '',
        starting_point: initialStartingPoint,
        arrival_city: initialArrivalCity,
        description: tour.description || '',
        is_published: initialIsPublished,
            ...
            <div className="space-y-10 max-w-5xl mx-auto w-full">
                <div>
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="font-display text-4xl font-bold text-indigo-ink">Edit Tour</h1>
                    </div>
                    <p className="text-muted-foreground mt-2">Update "{tour.title}" details.</p>
                </div>
